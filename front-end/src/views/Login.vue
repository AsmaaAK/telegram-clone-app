  ...
  <div class="min-h-screen w-full flex items-center justify-center px-4 bg-white dark:bg-gray-900">
    <div class="w-full max-w-sm">
      ...
      <div class="text-center mb-8">
        ...
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Telegram</h1>
        <p class="text-gray-500 dark:text-gray-400">Please confirm your country and enter your phone number.</p>
      </div>
